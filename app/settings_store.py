...
ここに入るのはユーザーが決めるものだけ — どの相手を使うか（on/off）、認証情報、
...
def _connect() -> sqlite3.Connection:
    ...
    # ファイルに焼き付く属性で、一度 WAL で作られた DB はコードを直しても WAL のまま。
